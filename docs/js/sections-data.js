...
window.SECTIONS = {
  ...
  <div class="max-w-6xl mx-auto px-6 py-4 flex flex-col min-[890px]:flex-row justify-center min-[890px]:justify-between items-center gap-3 min-[890px]:gap-0">
    <a href="#hero" class="text-lg font-semibold text-white"><span id="nav-typing-text"></span><span id="nav-typing-cursor">_</span></a>
    <!-- Desktop nav (≥890px) -->
    <ul class="hidden min-[890px]:flex items-center gap-8 text-sm text-slate-400">
    ...
    <!-- Mobile trigger + dropdown (≤889px) -->
    <div class="flex flex-col min-[890px]:hidden items-center gap-2 w-full min-[890px]:w-auto">
